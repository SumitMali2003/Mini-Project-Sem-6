...
# Define class labels
class_labels = {0: "Organic", 1: "Recyclable", 2: "Metal", 3: "Cardboard"}  # Update as per your dataset class mapping
...
with st.sidebar:
    ...
    **Waste Classification By Using CNN Model**
    ...
    - This project uses a **CNN model** to classify waste into **Organic, Recyclable, Metal, Cardboard**.
...
if uploaded_file is not None:
    ...
    with col2:
        ...
        if predicted_label == "Organic":
            ...
            st.markdown(" **This waste is metal!**")
        elif(predicted_label=="cardboard"):
            st.markdown(" **This waste is cardboard!**")
        else:
            st.markdown("no img found")
